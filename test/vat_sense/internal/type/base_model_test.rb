...
class VatSense::Test::PrimitiveModelTest < Minitest::Test
  A = VatSense::Internal::Type::ArrayOf[-> { Integer }]
  H = VatSense::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < VatSense::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      VatSense::Internal::Type::Unknown,
      VatSense::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => VatSense::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [VatSense::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [VatSense::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [VatSense::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = VatSense::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        VatSense::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [VatSense::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [VatSense::Internal::Type::Boolean, true] => true,
      [VatSense::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => VatSense::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        VatSense::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = VatSense::Internal::Type::Converter.new_coerce_state
      VatSense::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        VatSense::Internal::Type::Converter.dump(target, input, state: state)
...
class VatSense::Test::EnumModelTest < Minitest::Test
  class E0
    include VatSense::Internal::Type::Enum
...
class VatSense::Test::CollectionModelTest < Minitest::Test
  A1 = VatSense::Internal::Type::ArrayOf[-> { Integer }]
  H1 = VatSense::Internal::Type::HashOf[Integer]

  A2 = VatSense::Internal::Type::ArrayOf[H1]
  H2 = VatSense::Internal::Type::HashOf[-> { A1 }]

  A3 = VatSense::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = VatSense::Internal::Type::HashOf[Integer, nil?: true]
...
class VatSense::Test::BaseModelTest < Minitest::Test
  class M1 < VatSense::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < VatSense::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < VatSense::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, VatSense::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = VatSense::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = VatSense::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(VatSense::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue VatSense::Errors::ConversionError => e
...
class VatSense::Test::UnionTest < Minitest::Test
  class U0
    include VatSense::Internal::Type::Union
  ...
  class M2 < VatSense::Internal::Type::BaseModel
  ...
  class M4 < VatSense::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, VatSense::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < VatSense::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, VatSense::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class VatSense::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include VatSense::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [VatSense::Internal::Type::Unknown, VatSense::Internal::Type::Unknown] => true,
      [VatSense::Internal::Type::Boolean, VatSense::Internal::Type::Boolean] => true,
      [VatSense::Internal::Type::Unknown, VatSense::Internal::Type::Boolean] => false,
...
class VatSense::Test::MetaInfoTest < Minitest::Test
  A1 = VatSense::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = VatSense::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
