...
class Vatsense::Test::SingletonClient < Vatsense::Client
  include Singleton
  ...
  def initialize
    super(
      base_url: Vatsense::Test::SingletonClient::TEST_API_BASE_URL,
...
class Vatsense::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @vat_sense = Vatsense::Test::SingletonClient.instance
  end
