    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { VatSense::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { VatSense::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            VatSense::FilePart.new(value)
          in VatSense::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in VatSense::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [VatSense::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: VatSense::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in VatSense::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in VatSense::Internal::Type::Converter
              ...
              VatSense::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(VatSense::Internal::Type::Converter, T::Class[T.anything]) }
        end
