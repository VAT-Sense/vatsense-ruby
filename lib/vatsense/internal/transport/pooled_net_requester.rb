      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Vatsense::Internal::Util.monotonic_secs
          ...
          def build_request(request, &blk)
            ...
            in String
              ...
              req.body_stream = Vatsense::Internal::Util::ReadIOAdapter.new(body, &blk)
            in StringIO
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Vatsense::Internal::Util.uri_origin(url)
          timeout = deadline - Vatsense::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Vatsense::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise Vatsense::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          _, response = enum.next
          body = Vatsense::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            loop { enum.next }
          end
