    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Vatsense::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Vatsense::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Vatsense::Internal::Type::BaseModel::KnownField,
                  { type: Vatsense::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Vatsense::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Vatsense::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Vatsense::Internal::AnyHash) }
        def to_h
        end
